...
export default function CityDetails() {
    ...
    return (
        <main>
            <div className=" h-[600px] grow flex flex-col items-center justify-center bg-no-repeat bg-center sm: w-full" style={{ backgroundImage: `url(${city.photo})` }}>
                ...
                <div className="flex w-[300px] justify-center items-center mt-10 sm:w-full">
                    <p className=" w-[500px] text-white font-semibold flex mt-1 text-center bg-stone-500 rounded-2xl shadow-2xl p-2 ">{city.smalldescription}</p>
                </div>
