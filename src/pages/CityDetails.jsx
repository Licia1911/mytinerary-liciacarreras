    ...
    return (
        <>
            <div className=" h-[600px] grow flex flex-col items-center justify-center bg-no-repeat bg-center " style={{ backgroundImage: `url(${city.photo})` }}>
                <div className="flex items-center justify-center text-white text-5xl font-bold shadow shadow-black">
                    <h1>{city.city}</h1>
                </div>
                ...
                <div className="flex flex-col w-[600px] justify-center items-center" >
                    <p className="  text-white font-semibold flex mt-2 text-center bg-stone-500 rounded-3xl shadow-2xl ">{city.smalldescription}</p>
                </div>
