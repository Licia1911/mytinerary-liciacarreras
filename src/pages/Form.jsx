...
export default function Form() {
    ...
    return (
        <>
            <div className="row flex h-[120vh] bg-cover bg-center justify-around items-center" style={{ backgroundImage: `url(../img/backgroundLog.jpg)` }}>
                <div className="w-[50%] flex items-center pl-20 pb-16">
                    <h1 className="text-4xl mx-3 font-bold" >My Tinerary</h1>
                    <IconoAnimado />
                </div>
                {changeForm ? <div className='flex  flex-col w-[400px] h-[500px] bg-neutral-50 p-6 '>
                    ...
                    <div className='flex items-end justify-center'>
                        <input type="text" className=' w-[150px] text-[12px] border-b border-[#1c1c1c] h-[30px] m-2' name='name' id='name' />
                        <img src="../../public/img/O.png" alt="O" className='flex m-2'/>
                        <input type="text" className=' w-[150px] text-[12px] border-b border-[#1c1c1c] h-[30px] m-2' name='lastName' id='lastName' />
                    </div>
                    ...
                    <div className="flex">
                        ...
                        <div class="ml-2 text-sm mt-6">
                            <label for="helper-checkbox" className="text-[12px] tetx-[#1C1C1C]">Please contact me via email</label>
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="flex h-[80px] items-end justify-end">
                        <div className="rounded-md bg-[#4F46E5] hover:bg-sky-600 text-white text-[16px] text-center cursor-pointer w-[100px] h-13 p-1 mb-2 mr-2">Continue </div>
                    </div>
                </div>}
