...
export default function Comments({ id, user }) {
    ...
    const defaultPhoto = '../../img/perfil1.png'
    ...
    function createComment(e) {
        ...
        if (user.name) {
            ...
            Swal.fire({
                ...
                footer: "Need an account?<a href='/auth/signup' style='color:#5e8bee'> Sign Up!</a>"
            }).then((result) => {
    ...
    return (
        <div className="flex flex-col w-[350px] sm:w-[650px] m-4 mb-6 p-2 text-sm border border-gray-400 rounded-xl shadow-lg">
