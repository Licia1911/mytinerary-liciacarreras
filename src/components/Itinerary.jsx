    ...
    return (
        <main>
            <div className="flex grow flex-col items-center justify-center mt-5 px-20">
                <div className="w-[350px] h-[850px] flex flex-col items-center justify-start bg-slate-100 sm:w-[750px] ">
