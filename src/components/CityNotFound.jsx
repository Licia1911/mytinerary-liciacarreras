...
export default function CityNotFound() {
    return (
        <div className="flex rounded justify-center items-center shadow-md border-solid w-[500px]">
            <p className=" flex text-black text-2xl items-center justify-evenly"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mr-3">
                ...
                Sorry, we couldn't find this city</p>
        </div>
    )
}
