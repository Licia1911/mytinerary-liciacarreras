    ...
    return (
        <div className=" flex items-center justify-center mb-4">
            <div className="flex mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="grey" stroke="black" className=" w-20 h-20 hidden sm:flex">
            ...
            <div className=" w-[300px] h-[200px] bg-no-repeat flex items-center justify-center bg-center" style={{ backgroundImage: `url(../img/under_construction3.png)` }}></div>
        </div>
    )
}
